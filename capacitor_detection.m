...
lines = houghlines(BW,theta,rho,P,'FillGap',3,'MinLength',35); %finding the lines %fillgap is the distance between two line segments associated with same Hough transform bin. 
